...
export default function BlockedPage() {
  ...
  return (
    <div className="flex min-h-[65vh] items-center justify-center">
      <div className="max-w-md rounded border border-red-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          Your Manager account has been blocked by an Admin. Contact CleanOnes
          administration for help.
        </p>
        <button
          onClick={signOut}
          className="mt-5 h-10 rounded bg-slate-900 px-5 text-sm font-semibold text-white"
        >
          Return to sign in
        </button>
      </div>
