    ...
    <div className="flex flex-wrap items-center gap-3">
      <div className="relative min-w-[260px] flex-1">
        ...
        <input
          ...
          className="h-10 w-full rounded-lg border border-slate-200 bg-white pl-9 pr-3 text-sm outline-none transition-colors focus:border-sky-400 focus:ring-1 focus:ring-sky-400"
        />
      </div>
      <div className="w-full sm:w-60">
        <Select
          ...
          options={[
            { value: "", label: t.escalations.allStatuses },
            { value: "open", label: `${t.escalations.open} (${counts.open})` },
            { value: "in_progress", label: `${t.extraServices.inProgress} (${counts.progress})` },
            { value: "resolved", label: `${t.escalations.resolved} (${counts.resolved})` },
            { value: "closed", label: t.escalations.closed },
          ]}
        />
      </div>
    </div>
