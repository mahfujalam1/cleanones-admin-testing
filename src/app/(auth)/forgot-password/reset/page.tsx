  ...
  return (
    <div className="w-full max-w-md space-y-5 rounded border border-slate-200 bg-white p-6 sm:p-8">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button type="submit" className="h-10 w-full cursor-pointer rounded bg-primary text-sm font-semibold text-white shadow-sm hover:bg-[#0284c7]">Reset Password</button>
      </form>
    </div>
  );
}
