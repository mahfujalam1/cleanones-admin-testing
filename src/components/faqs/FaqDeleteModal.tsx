      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-5 sm:p-6 shadow-xl border border-slate-100">
        ...
        <div className="mt-5 flex items-center justify-end gap-2.5 border-t border-slate-100 pt-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className="rounded-xl bg-red-600 px-4 py-2 text-xs font-semibold text-white shadow-xs hover:bg-red-700 transition-colors disabled:opacity-60 cursor-pointer"
          >
