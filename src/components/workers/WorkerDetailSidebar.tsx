...
export function WorkerDetailSidebar({ worker, onClose }: WorkerDetailSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed inset-y-0 right-0 w-[420px] bg-white border-l border-gray-200 shadow-2xl z-50 flex flex-col transform transition-transform animate-in slide-in-from-right duration-300">
        {/* Header */}
