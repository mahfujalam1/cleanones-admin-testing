...
export async function getLocationCleaningPlans(
  locationId: string,
): Promise<ActionResult<LocationCleaningPlans>> {
  return authenticated<LocationCleaningPlans>(
